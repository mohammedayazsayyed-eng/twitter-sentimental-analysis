...
# download_from_drive(MODEL_FILE_ID, 'trained_model1.sav')
# download_from_drive(VECTORIZER_FILE_ID, 'vectorizer.pkl')


# Paths
# BASE_DIR = os.path.dirname(__file__)
# MODEL_PATH = os.path.join(BASE_DIR, 'trained_model1.sav')
# VECTORIZER_PATH = os.path.join(BASE_DIR, 'vectorizer.pkl')

MODEL_PATH = "trained_modelA.sav"
VECTORIZER_PATH = "vectorizerA.pkl"
...
with open(VECTORIZER_PATH, "rb") as f:
    vectorizer = pickle.load(f)  # ✅ now 'vectorizer' is a TfidfVectorizer object

# # Predict new tweet
# new_tweet = ["I love this!"]
# X_new = vectorizer.transform(new_tweet)  # ✅ use the loaded object
